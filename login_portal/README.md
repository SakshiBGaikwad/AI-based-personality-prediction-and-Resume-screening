...
[PersoAnalyzer.com](http://phoebemensah.pythonanywhere.com/)
...
[PersoAnalyzer Demo Video](https://drive.google.com/drive/u/0/folders/161UDIjruZur61fq8F_vkUc6TFXbvjOHH)
...
To install PersoAnalyzer you'll need pip and Git. It also uses a some Python packages (NumPy, SciPy and Matplotlib) but these should be taken care of by the installation process.
...
You can install PersoAnalyzer by cloning the repository:
...
PersoAnalyzer is still an experimental prototype however instances fit for specific use cases can be spawned and developed for your use. In order to contact us for such an endeavor please check out the contributors for this project.
